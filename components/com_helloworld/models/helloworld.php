...
class HelloWorldModelHelloWorld extends JModelItem
{
	...
	public function getItem()
	{
		if (!isset($this->item))
		{
			...
			$query->select('h.greeting, h.params,  h.email as email, h.mobile as mobile, h.image as image,
			c.title as category, h.latitude as latitude, h.longitude as longitude')
