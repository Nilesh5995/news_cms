<div class="container" style="height: 100%; width: 80%;">
  <h2><?php echo JText::_('COM_SCHOOL_TEACHER_INFORMATION'); ?>
</h2>
<!--   <p>The .table-striped class adds zebra-stripes to a table:</p>   -->          
  <table class="table table-striped" style="height: 100%; width: 100%;">
    ...
    <tr>
    	<td>
    		 <strong>Education</strong>   : <?php echo $this->item->education;?>
    	</td>
	</tr>
    <tr>  
    	<td>
    ...
    <tr>
        <td>
        	<strong>Mobile No..</strong> : <?php echo $this->item->mobile;?>
        </td>
    </tr>
    <tr>
        <td>
