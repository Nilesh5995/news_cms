...
?>
<form action="index.php?option=com_school&view=student_lists" method="post" id="adminForm" name="adminForm">
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				<?php foreach ($this->items as $i => $row) : 
					$link = JRoute::_('index.php?option=com_school&task=student_list.edit&id=' . $row->id);
				?>
